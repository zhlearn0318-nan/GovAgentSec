...
```powershell
'C:\GovAgentSec\modules\aegis\.runtime_mcp313\Scripts\python.exe' 'C:\GovAgentSec\modules\aegis\demo_web\tools\evaluation\run_skilltrustbench.py' --mode full --output-dir 'C:\GovAgentSec\modules\aegis\demo_web\artifacts\analysis\2026-08-14-skilltrustbench-full-cisco-parallel-v1' --timeout-seconds 150 --workers 4
```
