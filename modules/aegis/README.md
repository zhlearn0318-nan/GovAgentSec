...
该仓库当前冻结为挑战杯“example-workspace”赛道 **正式比赛版本 v0.2**，现场演示和材料提交状态为 READY。它仍是研究与竞赛原型，不等价于可直接接入真实政企生产网的商业安全产品；洁净 Windows VM、企业身份权限、外部审计、高可用和更强隔离仍未完成，生产发布保持 NO-GO。完整边界见 [`CURRENT_STATUS.md`](CURRENT_STATUS.md)。
